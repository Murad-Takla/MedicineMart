...
<head>
    ...
    <link rel="stylesheet" href="editmedicine.css">
...
<body>
    <div class="row">
        ...
        <div class="col-lg-12 adminlogin-header2">
            <h1 class="my-adminl-h1 mt-lg-1">Edit Medicine</h1>

            <div class="mt-4">
                <form action="editverify.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="text-center">
                        ...
                        <input class="btn btn-primary mt-4" type="submit" name="submit" value="Edit">
