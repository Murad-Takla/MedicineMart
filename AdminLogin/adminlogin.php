...
<body>
    <div class="row">
        ...
        <div class="col-lg-5 adminlogin-header2">
            <h1 class="my-adminl-h1 mt-lg-4">Admin Login</h1>

            <div class="text-center mt-4">
                <form action="./adminverify.php" method="POST">
                    <div class="form-group adminl-form1">
                        <label for="user" class="mb-2">Name</label>
                        <input required class="form-control input-sm" id="name" name="name" type="text" placeholder="Name">
                    </div>
                    ...
                    <p class="mt-4 my-hidden">This is taking space</p>
                </form>
            </div>
        ...
        <div class="adminlogin-header3">
            <h2 class="adminl-h2">Note: If you are not an admin, please click back</h2>
        </div>
